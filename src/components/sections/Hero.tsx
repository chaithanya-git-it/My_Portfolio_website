  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <strong style={{ color: "#f8f8f2", fontWeight: 500 }}>React Native Developer</strong> with{" "}
          <strong style={{ color: "#d8b4e2", fontWeight: 500 }}>3.5 years</strong> of experience building
          Android & iOS apps. 🏆 <em style={{ color: "#ffd700", fontStyle: "normal", fontWeight: 500 }}>Tech Titan Award</em> winner at Digit Insurance.
        </motion.p>
        ...
        >
          {[
            ...
            { num: "20%", label: "Bug Reduction (TS)" },
            { num: "🏆", label: "Tech Titan Award" },
          ].map(({ num, label }) => (
            <div key={label}>
